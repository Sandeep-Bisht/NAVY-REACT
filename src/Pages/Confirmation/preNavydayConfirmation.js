...
const PreNavydayConfirmation = () => {
  ...
  let invitationResponseHandler = async (guest_response) => {
    ...
    let url = `${apiBaseUrl}markPreNavydayAvailability`;
        ...
        <div className="container">
          <div className="row pt-5">
            <div className="col-md-12 smsContent">
              {userData && userData.preNavydayAvailability == "null" ? (
                <>
...
export default PreNavydayConfirmation;
